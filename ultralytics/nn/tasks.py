...
class EfficientNetBackbone(nn.Module):
    def __init__(self, model_name='efficientnet_b0', output_stride=32):
        super().__init__()
        efficientnet = efficientnet_b0(pretrained=True)
        self.features = nn.Sequential(*list(efficientnet.children())[:-2])  # Modify as needed for your architecture
